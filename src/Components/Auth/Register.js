  ...
  return (
    <ScrollView style={styles.container} showsHorizontalScrollIndicator={false}>
        ...
        <View style={styles.imgBg}>
          {/* Image Background */}
          <Image source={require('./../../../assets/img/auth/register.png')} resizeMode="contain" style={styles.image} />
        </View>
        ...
        <View style={styles.form}>
          ...
          <Text onPress={()=>navigation.navigate('Login')} style={styles.forgot}>Already have an account? <Text style={{color:'#0094FF'}}>Sign In</Text></Text>
